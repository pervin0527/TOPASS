...
배경지식, 문제해결능력, 코드 구현력을 두루 갖춰야한다.

- 배경지식 : 다양한 알고리즘, 자료구조, 그 외 테크닉들에 대한 기본지식을 갖춰 문제를 해결한다. $rarr$ 강의를 잘보고 공부하자.
- 문제해결능력 : 배경지식을 지금 풀어야할 문제에 맞게 잘 변형해서 적용 시키는 능력. $rarr$ 여러 가지 문제를 스스로 풀어보려 노력하자.
- 구현력 : 본인이 생각한 풀이를 코드로 옮겨낼 수 있는가? $rarr$ 이것 역시 여러 가지 문제를 많이 풀어봐야함. + 다른 사람들은 어떻게 풀었는지 보고 분석.
...
| 기본 문제✔ | 1992  |       [⭐️쿼드트리](https://www.acmicpc.net/problem/1992)       | [정답 코드](./0x0B_Recursive/1992.py)  |
| 응용 문제✔ | 2447  |     [⭐️별 찍기 - 10](https://www.acmicpc.net/problem/2447)     | [정답 코드](./0x0B_Recursive/2447.py)  |
...
| 기본 문제✔ | 15650 |     [N과 M (2)](https://www.acmicpc.net/problem/15650)     | [정답 코드](./0x0C_BackTracking/15650.py) |
| 기본 문제✔ | 15651 |     [N과 M (3)](https://www.acmicpc.net/problem/15651)     | [정답 코드](./0x0C_BackTracking/15651.py) |
| 기본 문제✔ | 15652 |     [N과 M (4)](https://www.acmicpc.net/problem/15652)     | [정답 코드](./0x0C_BackTracking/15652.py) |
| 기본 문제✔ | 15654 |     [N과 M (5)](https://www.acmicpc.net/problem/15654)     | [정답 코드](./0x0C_BackTracking/15654.py) |
| 기본 문제✔ | 15655 |     [N과 M (6)](https://www.acmicpc.net/problem/15655)     | [정답 코드](./0x0C_BackTracking/15655.py) |
...
### 0x0D Simulation(시뮬레이션)

[문제집 링크](https://www.acmicpc.net/workbook/view/7316)

| 문제 분류  | 문제  |                                     문제 제목                                     |               정답 코드               |
| :--------: | :---: | :-------------------------------------------------------------------------------: | :-----------------------------------: |
| 연습 문제  | 15683 |                   [감시](https://www.acmicpc.net/problem/15683)                   |             [정답 코드]()             |
| 연습 문제  | 18808 |              [스티커 붙이기](https://www.acmicpc.net/problem/18808)               |             [정답 코드]()             |
| 연습 문제  | 12100 |               [2048 (Easy)](https://www.acmicpc.net/problem/12100)                |             [정답 코드]()             |
| 연습 문제  | 15686 |                [치킨 배달](https://www.acmicpc.net/problem/15686)                 |             [정답 코드]()             |
| 기본 문제✔ | 11559 |                [Puyo Puyo](https://www.acmicpc.net/problem/11559)                 |             [정답 코드]()             |
| 기본 문제✔ | 14891 |                 [톱니바퀴](https://www.acmicpc.net/problem/14891)                 |             [정답 코드]()             |
| 기본 문제✔ | 14499 |              [주사위 굴리기](https://www.acmicpc.net/problem/14499)               |             [정답 코드]()             |
| 기본 문제✔ | 13335 |                   [트럭](https://www.acmicpc.net/problem/13335)                   |       [정답 코드](), [별해 1]()       |
...
| 기본 문제✔ | 14500 |                [테트로미노](https://www.acmicpc.net/problem/14500)                | [정답 코드](), [별해 1](), [별해 2]() |
| 기본 문제✔ | 13460 |               [구슬 탈출 2](https://www.acmicpc.net/problem/13460)                |             [정답 코드]()             |
| 기본 문제✔ | 14502 |                  [연구소](https://www.acmicpc.net/problem/14502)                  | [정답 코드](), [별해 1](), [별해 2]() |
| 기본 문제✔ | 14888 |             [연산자 끼워넣기](https://www.acmicpc.net/problem/14888)              |       [정답 코드](), [별해 1]()       |
...
| 기본 문제  | 17281 |                    [⚾](https://www.acmicpc.net/problem/17281)                    |       [정답 코드](), [별해 1]()       |
| 기본 문제  | 5373  |                   [큐빙](https://www.acmicpc.net/problem/5373)                    |             [정답 코드]()             |
| 기본 문제  | 16234 |                [인구 이동](https://www.acmicpc.net/problem/16234)                 |             [정답 코드]()             |
...
| 기본 문제  | 17070 |             [파이프 옮기기 1](https://www.acmicpc.net/problem/17070)              |       [정답 코드](), [별해 1]()       |
...
### 0x0E Sort Part1(정렬 파트1)

- [선택, 버블, 삽입 정렬 개념](https://pervin0527.notion.site/Sort-Part1-a801d769f14f4106a3a0b3092b04fdee?pvs=4)
- [병합 정렬](https://pervin0527.notion.site/Sort-Part2-f9a7d7c216244d39b3898d449921fdc5?pvs=4)
- [문제집 링크](https://www.acmicpc.net/workbook/view/7317)

| 문제 분류 | 문제  |                       문제 제목                        |             정답 코드              |
| :-------: | :---: | :----------------------------------------------------: | :--------------------------------: |
| 기본 문제 | 2750  |  [수 정렬하기](https://www.acmicpc.net/problem/2750)   | [정답 코드](./0x0E_Sort1/2750.py)  |
| 기본 문제 | 2751  | [수 정렬하기 2](https://www.acmicpc.net/problem/2751)  | [정답 코드](./0x0E_Sort1/2751.py)  |
| 기본 문제 | 10989 | [수 정렬하기 3](https://www.acmicpc.net/problem/10989) | [정답 코드](./0x0E_Sort1/10989.py) |
| 기본 문제 | 11931 | [수 정렬하기 4](https://www.acmicpc.net/problem/11931) | [정답 코드](./0x0E_Sort1/11931.py) |
| 기본 문제 | 15688 | [수 정렬하기 5](https://www.acmicpc.net/problem/15688) | [정답 코드](./0x0E_Sort1/15688.py) |
| 기본 문제 | 10814 |  [나이순 정렬](https://www.acmicpc.net/problem/10814)  | [정답 코드](./0x0E_Sort1/10814.py) |
| 기본 문제 | 11650 | [좌표 정렬하기](https://www.acmicpc.net/problem/11650) | [정답 코드](./0x0E_Sort1/11650.py) |

### 0x0F Sort Part2(정렬 파트2)

- [문제집 링크](https://www.acmicpc.net/workbook/view/7318)

| 문제 분류  | 문제  |                            문제 제목                            |             정답 코드              |
| :--------: | :---: | :-------------------------------------------------------------: | :--------------------------------: |
| 연습 문제  | 1431  |     [⭐️시리얼 번호](https://www.acmicpc.net/problem/1431)      | [정답 코드](./0x0F_Sort2/1431.py)  |
| 연습 문제  | 11652 |        [⭐️카드](https://www.acmicpc.net/problem/11652)         | [정답 코드](./0x0F_Sort2/11652.py) |
| 기본 문제✔ | 5648  |       [역원소 정렬](https://www.acmicpc.net/problem/5648)       | [정답 코드](./0x0F_Sort2/5648.py)  |
| 기본 문제✔ | 1181  |        [단어 정렬](https://www.acmicpc.net/problem/1181)        | [정답 코드](./0x0F_Sort2/1181.py)  |
| 기본 문제✔ | 2910  |      [⭐️빈도 정렬](https://www.acmicpc.net/problem/2910)       |           [정답 코드]()            |
| 기본 문제  | 10814 |      [나이순 정렬](https://www.acmicpc.net/problem/10814)       |           [정답 코드]()            |
| 기본 문제  | 11656 |      [접미사 배열](https://www.acmicpc.net/problem/11656)       |           [정답 코드]()            |
| 기본 문제  | 10825 |         [국영수](https://www.acmicpc.net/problem/10825)         |           [정답 코드]()            |
| 응용 문제✔ | 7795  | [먹을 것인가 먹힐 것인가](https://www.acmicpc.net/problem/7795) |           [정답 코드]()            |
